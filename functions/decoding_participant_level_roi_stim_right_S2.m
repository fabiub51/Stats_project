function decoding_participant_level_roi_stim_right_S2(sub_no)

dir = strcat('C:\Users\berne\Documents\Master FU\2. Semester\Stats\Decoding\data\sub-00', num2str(sub_no));
 
mkdir(dir,'\results_decoding_roi_stim_right_S2')
...
if sub_no < 10
    cfg.results.dir = strcat('C:\Users\berne\Documents\Master FU\2. Semester\Stats\Decoding\data\sub-00',num2str(sub_no),'\results_decoding_roi_stim_right_S2');
else
    cfg.results.dir = strcat('C:\Users\berne\Documents\Master FU\2. Semester\Stats\Decoding\data\sub-0',num2str(sub_no),'\results_decoding_roi_stim_right_S2');
end
...
cfg.files.mask = 'C:\Users\berne\Documents\Master FU\2. Semester\Stats\Decoding\data\2nd_level_analysis\Right S2.nii';
