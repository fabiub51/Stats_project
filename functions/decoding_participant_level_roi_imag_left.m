...
if sub_no < 10
    cfg.results.dir = strcat('C:\Users\berne\Documents\Master FU\2. Semester\Stats\Decoding\data\sub-00',num2str(sub_no),'\results_decoding_roi_imag_left');
else
    cfg.results.dir = strcat('C:\Users\berne\Documents\Master FU\2. Semester\Stats\Decoding\data\sub-0',num2str(sub_no),'\results_decoding_roi_imag_left');
end
...
cfg.files.mask = 'C:\Users\berne\Documents\Master FU\2. Semester\Stats\Decoding\data\2nd_level_imag\Left_1_2.nii';
