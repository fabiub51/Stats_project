function decoding_participant_level_roi_stim_occipital(sub_no)

dir = strcat('C:\Users\berne\Documents\Master FU\2. Semester\Stats\Decoding\data\sub-00', num2str(sub_no));
 
mkdir(dir,'\results_decoding_roi_stim_occipital')
...
if sub_no < 10
    cfg.results.dir = strcat('C:\Users\berne\Documents\Master FU\2. Semester\Stats\Decoding\data\sub-00',num2str(sub_no),'\results_decoding_roi_stim_occipital');
else
    cfg.results.dir = strcat('C:\Users\berne\Documents\Master FU\2. Semester\Stats\Decoding\data\sub-0',num2str(sub_no),'\results_decoding_roi_stim_occipital');
end
...
cfg.files.mask = 'C:\Users\berne\Documents\Master FU\2. Semester\Stats\Decoding\data\2nd_level_analysis\Occipital.nii';
